...
If you ever close the terminal, reactivate the Python virtual environment with:
...
pip install -r requirements.txt
    # if this gives you a problem, try: `py .\env\Scripts\pip.exe install -r requirements.txt`

4. Initialize the database
python3 init_db.py          or 	python init_db.py           or 	    py init_db.py 
...
- clean 404 errors, or generic 500 messages
...
Run it with:
python3 exploit/exploit_bugboard.py     or      python exploit/exploit_bugboard.py     or      py exploit/exploit_bugboard.py
